...
---@class ___plugin_name___.kit.App.Config.Schema # kit.macro.remove

---@alias ___plugin_name___.kit.App.Config.SchemaInternal ___plugin_name___.kit.App.Config.Schema|{ revision: integer }

---@class ___plugin_name___.kit.App.Config
---@field private _cache ___plugin_name___.kit.App.Cache
---@field private _default ___plugin_name___.kit.App.Config.SchemaInternal
---@field private _global ___plugin_name___.kit.App.Config.SchemaInternal
...
---@param config ___plugin_name___.kit.App.Config.Schema
...
---@return ___plugin_name___.kit.App.Config.Schema
function Config:get()
...
---@return fun(config: ___plugin_name___.kit.App.Config.Schema)|{ filetype: fun(filetypes: string|string[], config: ___plugin_name___.kit.App.Config.Schema), buffer: fun(bufnr: integer, config: ___plugin_name___.kit.App.Config.Schema) }
