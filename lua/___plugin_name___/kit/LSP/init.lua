...
---@field public event ___plugin_name___.kit.LSP.WorkspaceFoldersChangeEvent The actual workspace folder change event.
...
---@field public partialResultToken? ___plugin_name___.kit.LSP.ProgressToken An optional token that a server can use to report partial results (e.g. streaming) to<br>the client.

---@class ___plugin_name___.kit.LSP.DocumentColorParams
---@field public textDocument ___plugin_name___.kit.LSP.TextDocumentIdentifier The text document.

---@class ___plugin_name___.kit.LSP.ColorInformation
---@field public range ___plugin_name___.kit.LSP.Range The range in the document where this color appears.
---@field public color ___plugin_name___.kit.LSP.Color The actual color value for this color range.
...
---@field public textDocument ___plugin_name___.kit.LSP.TextDocumentIdentifier The text document.
---@field public color ___plugin_name___.kit.LSP.Color The color to request presentations for.
---@field public range ___plugin_name___.kit.LSP.Range The range where the color would be inserted. Serves as a context.
...
---@field public textEdit? ___plugin_name___.kit.LSP.TextEdit An [edit](#TextEdit) which is applied to a document when selecting<br>this presentation for the color.  When `falsy` the [label](#ColorPresentation.label)<br>is used.
---@field public additionalTextEdits? ___plugin_name___.kit.LSP.TextEdit[] An optional array of additional [text edits](#TextEdit) that are applied when<br>selecting this color presentation. Edits must not overlap with the main [edit](#ColorPresentation.textEdit) nor with themselves.
...
---@field public documentSelector (___plugin_name___.kit.LSP.DocumentSelector | nil) A document selector to identify the scope of the registration. If set to null<br>the document selector provided on the client side will be used.
...
---@field public kind? ___plugin_name___.kit.LSP.FoldingRangeKind Describes the kind of the folding range such as `comment' or 'region'. The kind<br>is used to categorize folding ranges and used by commands like 'Fold all comments'.<br>See [FoldingRangeKind](#FoldingRangeKind) for an enumeration of standardized kinds.
...
---@field public textDocument ___plugin_name___.kit.LSP.TextDocumentIdentifier The text document.
---@field public positions ___plugin_name___.kit.LSP.Position[] The positions inside the text document.

---@class ___plugin_name___.kit.LSP.SelectionRange
---@field public range ___plugin_name___.kit.LSP.Range The [range](#Range) of this selection range.
---@field public parent? ___plugin_name___.kit.LSP.SelectionRange The parent selection range containing this range. Therefore `parent.range` must contain `this.range`.
...
---@field public token ___plugin_name___.kit.LSP.ProgressToken The token to be used to report progress.
...
---@field public kind ___plugin_name___.kit.LSP.SymbolKind The kind of this item.
---@field public tags? ___plugin_name___.kit.LSP.SymbolTag[] Tags for this item.
...
---@field public range ___plugin_name___.kit.LSP.Range The range enclosing this symbol not including leading/trailing whitespace but everything else, e.g. comments and code.
---@field public selectionRange ___plugin_name___.kit.LSP.Range The range that should be selected and revealed when this symbol is being picked, e.g. the name of a function.<br>Must be contained by the [`range`](#CallHierarchyItem.range).
---@field public data? ___plugin_name___.kit.LSP.LSPAny A data entry field that is preserved between a call hierarchy prepare and<br>incoming calls or outgoing calls requests.
...
---@field public from ___plugin_name___.kit.LSP.CallHierarchyItem The item that makes the call.
---@field public fromRanges ___plugin_name___.kit.LSP.Range[] The ranges at which the calls appear. This is relative to the caller<br>denoted by [`this.from`](#CallHierarchyIncomingCall.from).
...
---@field public to ___plugin_name___.kit.LSP.CallHierarchyItem The item that is called.
---@field public fromRanges ___plugin_name___.kit.LSP.Range[] The range at which this item is called. This is the range relative to the caller, e.g the item<br>passed to [`provideCallHierarchyOutgoingCalls`](#CallHierarchyItemProvider.provideCallHierarchyOutgoingCalls)<br>and not [`this.to`](#CallHierarchyOutgoingCall.to).
...
---@field public edits ___plugin_name___.kit.LSP.SemanticTokensEdit[] The semantic token edits to transform a previous result into a new result.
...
---@field public textDocument ___plugin_name___.kit.LSP.TextDocumentIdentifier The text document.
---@field public range ___plugin_name___.kit.LSP.Range The range the semantic tokens are requested for.
...
---@field public selection? ___plugin_name___.kit.LSP.Range An optional selection range if the document is a text<br>document. Clients might ignore the property if an<br>external program is started or the file is not a text<br>file.
...
---@field public ranges ___plugin_name___.kit.LSP.Range[] A list of ranges that can be edited together. The ranges must have<br>identical length and contain identical text content. The ranges cannot overlap.
...
---@field public unique ___plugin_name___.kit.LSP.UniquenessLevel The scope in which the moniker is unique
---@field public kind? ___plugin_name___.kit.LSP.MonikerKind The moniker kind if known.
...
---@field public detail? string More detail for this item, e.g. the signature of a function.
---@field public uri string The resource identifier of this item.
---@field public range ___plugin_name___.kit.LSP.Range The range enclosing this symbol not including leading/trailing whitespace<br>but everything else, e.g. comments and code.
---@field public selectionRange ___plugin_name___.kit.LSP.Range The range that should be selected and revealed when this symbol is being<br>picked, e.g. the name of a function. Must be contained by the<br>[`range`](#TypeHierarchyItem.range).
---@field public data? ___plugin_name___.kit.LSP.LSPAny A data entry field that is preserved between a type hierarchy prepare and<br>supertypes or subtypes requests. It could also be used to identify the<br>type hierarchy in the server, helping improve the performance on<br>resolving supertypes and subtypes.
...
---@field public textDocument ___plugin_name___.kit.LSP.TextDocumentIdentifier The text document.
---@field public range ___plugin_name___.kit.LSP.Range The document range for which inline values should be computed.
---@field public context ___plugin_name___.kit.LSP.InlineValueContext Additional information about the context in which inline values were<br>requested.
...
---@field public textDocument ___plugin_name___.kit.LSP.TextDocumentIdentifier The text document.
---@field public range ___plugin_name___.kit.LSP.Range The document range for which inlay hints should be computed.

---@class ___plugin_name___.kit.LSP.InlayHint
---@field public position ___plugin_name___.kit.LSP.Position The position of this hint.
---@field public label (string | ___plugin_name___.kit.LSP.InlayHintLabelPart[]) The label of this hint. A human readable string or an array of<br>InlayHintLabelPart label parts.<br><br>*Note* that neither the string nor the label part can be empty.
---@field public kind? ___plugin_name___.kit.LSP.InlayHintKind The kind of this hint. Can be omitted in which case the client<br>should fall back to a reasonable default.
---@field public textEdits? ___plugin_name___.kit.LSP.TextEdit[] Optional text edits that are performed when accepting this inlay hint.<br><br>*Note* that edits are expected to change the document so that the inlay<br>hint (or its nearest variant) is now part of the document and the inlay<br>hint itself is now obsolete.
---@field public tooltip? (string | ___plugin_name___.kit.LSP.MarkupContent) The tooltip text when you hover over this item.
...
---@field public data? ___plugin_name___.kit.LSP.LSPAny A data entry field that is preserved on an inlay hint between<br>a `textDocument/inlayHint` and a `inlayHint/resolve` request.
...
---@field public identifier? string The additional identifier provided during registration.
---@field public previousResultIds ___plugin_name___.kit.LSP.PreviousResultId[] The currently known diagnostic reports with their<br>previous result ids.
...
---@field public capabilities ___plugin_name___.kit.LSP.ServerCapabilities The capabilities the language server provides.
---@field public serverInfo? ___plugin_name___.kit.LSP.InitializeResult.serverInfo Information about the server.<br><br>@since 3.15.0

---@class ___plugin_name___.kit.LSP.InitializeResult.serverInfo
...
---@field public settings ___plugin_name___.kit.LSP.LSPAny The actual changed settings
...
---@field public type ___plugin_name___.kit.LSP.MessageType The message type. See {@link MessageType}
---@field public message string The actual message.

---@class ___plugin_name___.kit.LSP.ShowMessageRequestParams
---@field public type ___plugin_name___.kit.LSP.MessageType The message type. See {@link MessageType}
---@field public message string The actual message.
---@field public actions? ___plugin_name___.kit.LSP.MessageActionItem[] The message action items to present.
...
---@field public textDocument ___plugin_name___.kit.LSP.TextDocumentItem The document that was opened.

---@class ___plugin_name___.kit.LSP.DidChangeTextDocumentParams
---@field public textDocument ___plugin_name___.kit.LSP.VersionedTextDocumentIdentifier The document that did change. The version number points<br>to the version after all provided content changes have<br>been applied.
---@field public contentChanges ___plugin_name___.kit.LSP.TextDocumentContentChangeEvent[] The actual content changes. The content changes describe single state changes<br>to the document. So if there are two content changes c1 (at array index 0) and<br>c2 (at array index 1) for a document in state S then c1 moves the document from<br>S to S' and c2 from S' to S''. So c1 is computed on the state S and c2 is computed<br>on the state S'.<br><br>To mirror the content of a document using change events use the following approach:<br>- start with the same initial content<br>- apply the 'textDocument/didChange' notifications in the order you receive them.<br>- apply the `TextDocumentContentChangeEvent`s in a single notification in the order<br>  you receive them.
...
---@field public syncKind ___plugin_name___.kit.LSP.TextDocumentSyncKind How documents are synced to the server.

---@class ___plugin_name___.kit.LSP.DidCloseTextDocumentParams
---@field public textDocument ___plugin_name___.kit.LSP.TextDocumentIdentifier The document that was closed.

---@class ___plugin_name___.kit.LSP.DidSaveTextDocumentParams
---@field public textDocument ___plugin_name___.kit.LSP.TextDocumentIdentifier The document that was saved.
...
---@field public textDocument ___plugin_name___.kit.LSP.TextDocumentIdentifier The document that will be saved.
---@field public reason ___plugin_name___.kit.LSP.TextDocumentSaveReason The 'TextDocumentSaveReason'.

---@class ___plugin_name___.kit.LSP.TextEdit
---@field public range ___plugin_name___.kit.LSP.Range The range of the text document to be manipulated. To insert<br>text into a document create a range where start === end.
...
---@field public changes ___plugin_name___.kit.LSP.FileEvent[] The actual file events.

---@class ___plugin_name___.kit.LSP.DidChangeWatchedFilesRegistrationOptions
---@field public watchers ___plugin_name___.kit.LSP.FileSystemWatcher[] The watchers to register.
...
---@field public diagnostics ___plugin_name___.kit.LSP.Diagnostic[] An array of diagnostic information items.

---@class ___plugin_name___.kit.LSP.CompletionParams : ___plugin_name___.kit.LSP.TextDocumentPositionParams
---@field public context? ___plugin_name___.kit.LSP.CompletionContext The completion context. This is only available it the client specifies<br>to send this using the client capability `textDocument.completion.contextSupport === true`
...
---@field public labelDetails? ___plugin_name___.kit.LSP.CompletionItemLabelDetails Additional details for the label<br><br>@since 3.17.0
---@field public kind? ___plugin_name___.kit.LSP.CompletionItemKind The kind of this completion item. Based of the kind<br>an icon is chosen by the editor.
---@field public tags? ___plugin_name___.kit.LSP.CompletionItemTag[] Tags for this completion item.<br><br>@since 3.15.0
...
---@field public documentation? (string | ___plugin_name___.kit.LSP.MarkupContent) A human-readable string that represents a doc-comment.
...
---@field public insertTextFormat? ___plugin_name___.kit.LSP.InsertTextFormat The format of the insert text. The format applies to both the<br>`insertText` property and the `newText` property of a provided<br>`textEdit`. If omitted defaults to `InsertTextFormat.PlainText`.<br><br>Please note that the insertTextFormat doesn't apply to<br>`additionalTextEdits`.
---@field public insertTextMode? ___plugin_name___.kit.LSP.InsertTextMode How whitespace and indentation is handled during completion<br>item insertion. If not provided the clients default value depends on<br>the `textDocument.completion.insertTextMode` client capability.<br><br>@since 3.16.0
---@field public textEdit? (___plugin_name___.kit.LSP.TextEdit | ___plugin_name___.kit.LSP.InsertReplaceEdit) An [edit](#TextEdit) which is applied to a document when selecting<br>this completion. When an edit is provided the value of<br>[insertText](#CompletionItem.insertText) is ignored.<br><br>Most editors support two different operations when accepting a completion<br>item. One is to insert a completion text and the other is to replace an<br>existing text with a completion text. Since this can usually not be<br>predetermined by a server it can report both ranges. Clients need to<br>signal support for `InsertReplaceEdits` via the<br>`textDocument.completion.insertReplaceSupport` client capability<br>property.<br><br>*Note 1:* The text edit's range as well as both ranges from an insert<br>replace edit must be a [single line] and they must contain the position<br>at which completion has been requested.<br>*Note 2:* If an `InsertReplaceEdit` is returned the edit's insert range<br>must be a prefix of the edit's replace range, that means it must be<br>contained and starting at the same position.<br><br>@since 3.16.0 additional type `InsertReplaceEdit`
...
---@field public command? ___plugin_name___.kit.LSP.Command An optional [command](#Command) that is executed *after* inserting this completion. *Note* that<br>additional modifications to the current document should be described with the<br>[additionalTextEdits](#CompletionItem.additionalTextEdits)-property.
---@field public data? ___plugin_name___.kit.LSP.LSPAny A data entry field that is preserved on a completion item between a<br>[CompletionRequest](#CompletionRequest) and a [CompletionResolveRequest](#CompletionResolveRequest).
...
---@field public itemDefaults? ___plugin_name___.kit.LSP.CompletionList.itemDefaults In many cases the items of an actual completion result share the same<br>value for properties like `commitCharacters` or the range of a text<br>edit. A completion list can therefore define item defaults which will<br>be used if a completion item itself doesn't specify the value.<br><br>If a completion list specifies a default value and a completion item<br>also specifies a corresponding value the one from the item is used.<br><br>Servers are only allowed to return default values if the client<br>signals support for this via the `completionList.itemDefaults`<br>capability.<br><br>@since 3.17.0
---@field public items ___plugin_name___.kit.LSP.CompletionItem[] The completion items.

---@class ___plugin_name___.kit.LSP.CompletionList.itemDefaults
---@field public commitCharacters? string[] A default commit character set.<br><br>@since 3.17.0
---@field public editRange? (___plugin_name___.kit.LSP.Range | { insert: ___plugin_name___.kit.LSP.Range, replace: ___plugin_name___.kit.LSP.Range }) A default edit range.<br><br>@since 3.17.0
---@field public insertTextFormat? ___plugin_name___.kit.LSP.InsertTextFormat A default insert text format.<br><br>@since 3.17.0
---@field public insertTextMode? ___plugin_name___.kit.LSP.InsertTextMode A default insert text mode.<br><br>@since 3.17.0
---@field public data? ___plugin_name___.kit.LSP.LSPAny A default data value.<br><br>@since 3.17.0
...
---@field public contents (___plugin_name___.kit.LSP.MarkupContent | ___plugin_name___.kit.LSP.MarkedString | ___plugin_name___.kit.LSP.MarkedString[]) The hover's content
---@field public range? ___plugin_name___.kit.LSP.Range An optional range inside the text document that is used to<br>visualize the hover, e.g. by changing the background color.
...
---@field public context? ___plugin_name___.kit.LSP.SignatureHelpContext The signature help context. This is only available if the client specifies<br>to send this using the client capability `textDocument.signatureHelp.contextSupport === true`<br><br>@since 3.15.0

---@class ___plugin_name___.kit.LSP.SignatureHelp
---@field public signatures ___plugin_name___.kit.LSP.SignatureInformation[] One or more signatures.
...
---@field public range ___plugin_name___.kit.LSP.Range The range this highlight applies to.
---@field public kind? ___plugin_name___.kit.LSP.DocumentHighlightKind The highlight kind, default is [text](#DocumentHighlightKind.Text).
...
---@field public kind ___plugin_name___.kit.LSP.SymbolKind The kind of this symbol.
---@field public tags? ___plugin_name___.kit.LSP.SymbolTag[] Tags for this document symbol.<br><br>@since 3.16.0
---@field public deprecated? boolean Indicates if this symbol is deprecated.<br><br>@deprecated Use tags instead
---@field public range ___plugin_name___.kit.LSP.Range The range enclosing this symbol not including leading/trailing whitespace but everything else<br>like comments. This information is typically used to determine if the clients cursor is<br>inside the symbol to reveal in the symbol in the UI.
---@field public selectionRange ___plugin_name___.kit.LSP.Range The range that should be selected and revealed when this symbol is being picked, e.g the name of a function.<br>Must be contained by the `range`.
---@field public children? ___plugin_name___.kit.LSP.DocumentSymbol[] Children of this symbol, e.g. properties of a class.
...
---@field public textDocument ___plugin_name___.kit.LSP.TextDocumentIdentifier The document in which the command was invoked.
---@field public range ___plugin_name___.kit.LSP.Range The range for which the command was invoked.
---@field public context ___plugin_name___.kit.LSP.CodeActionContext Context carrying additional information.
...
---@field public arguments? ___plugin_name___.kit.LSP.LSPAny[] Arguments that the command handler should be<br>invoked with.

---@class ___plugin_name___.kit.LSP.CodeAction
---@field public title string A short, human-readable, title for this code action.
---@field public kind? ___plugin_name___.kit.LSP.CodeActionKind The kind of the code action.<br><br>Used to filter code actions.
---@field public diagnostics? ___plugin_name___.kit.LSP.Diagnostic[] The diagnostics that this code action resolves.
...
---@field public disabled? ___plugin_name___.kit.LSP.CodeAction.disabled Marks that the code action cannot currently be applied.<br><br>Clients should follow the following guidelines regarding disabled code actions:<br><br>  - Disabled code actions are not shown in automatic [lightbulbs](https://code.visualstudio.com/docs/editor/editingevolved#_code-action)<br>    code action menus.<br><br>  - Disabled actions are shown as faded out in the code action menu when the user requests a more specific type<br>    of code action, such as refactorings.<br><br>  - If the user has a [keybinding](https://code.visualstudio.com/docs/editor/refactoring#_keybindings-for-code-actions)<br>    that auto applies a code action and only disabled code actions are returned, the client should show the user an<br>    error message with `reason` in the editor.<br><br>@since 3.16.0
---@field public edit? ___plugin_name___.kit.LSP.WorkspaceEdit The workspace edit this code action performs.
---@field public command? ___plugin_name___.kit.LSP.Command A command this code action executes. If a code action<br>provides an edit and a command, first the edit is<br>executed and then the command.
---@field public data? ___plugin_name___.kit.LSP.LSPAny A data entry field that is preserved on a code action between<br>a `textDocument/codeAction` and a `codeAction/resolve` request.<br><br>@since 3.16.0

---@class ___plugin_name___.kit.LSP.CodeAction.disabled
...
---@field public location (___plugin_name___.kit.LSP.Location | { uri: string }) The location of the symbol. Whether a server is allowed to<br>return a location without a range depends on the client<br>capability `workspace.symbol.resolveSupport`.<br><br>See SymbolInformation#location for more details.
---@field public data? ___plugin_name___.kit.LSP.LSPAny A data entry field that is preserved on a workspace symbol between a<br>workspace symbol request and a workspace symbol resolve request.
...
---@field public textDocument ___plugin_name___.kit.LSP.TextDocumentIdentifier The document to request code lens for.

---@class ___plugin_name___.kit.LSP.CodeLens
---@field public range ___plugin_name___.kit.LSP.Range The range in which this code lens is valid. Should only span a single line.
---@field public command? ___plugin_name___.kit.LSP.Command The command this code lens represents.
---@field public data? ___plugin_name___.kit.LSP.LSPAny A data entry field that is preserved on a code lens item between<br>a [CodeLensRequest](#CodeLensRequest) and a [CodeLensResolveRequest]<br>(#CodeLensResolveRequest)
...
---@field public textDocument ___plugin_name___.kit.LSP.TextDocumentIdentifier The document to provide document links for.

---@class ___plugin_name___.kit.LSP.DocumentLink
---@field public range ___plugin_name___.kit.LSP.Range The range this link applies to.
...
---@field public data? ___plugin_name___.kit.LSP.LSPAny A data entry field that is preserved on a document link between a<br>DocumentLinkRequest and a DocumentLinkResolveRequest.
...
---@field public textDocument ___plugin_name___.kit.LSP.TextDocumentIdentifier The document to format.
---@field public options ___plugin_name___.kit.LSP.FormattingOptions The format options.
...
---@field public textDocument ___plugin_name___.kit.LSP.TextDocumentIdentifier The document to format.
---@field public range ___plugin_name___.kit.LSP.Range The range to format
---@field public options ___plugin_name___.kit.LSP.FormattingOptions The format options
...
---@field public textDocument ___plugin_name___.kit.LSP.TextDocumentIdentifier The document to format.
---@field public position ___plugin_name___.kit.LSP.Position The position around which the on type formatting should happen.<br>This is not necessarily the exact position where the character denoted<br>by the property `ch` got typed.
...
---@field public options ___plugin_name___.kit.LSP.FormattingOptions The formatting options.
...
---@field public textDocument ___plugin_name___.kit.LSP.TextDocumentIdentifier The document to rename.
---@field public position ___plugin_name___.kit.LSP.Position The position at which this request was sent.
...
---@field public command string The identifier of the actual command handler.
---@field public arguments? ___plugin_name___.kit.LSP.LSPAny[] Arguments that the command should be invoked with.
...
---@field public edit ___plugin_name___.kit.LSP.WorkspaceEdit The edits to apply.
...
---@field public token ___plugin_name___.kit.LSP.ProgressToken The progress token provided by the client or server.
---@field public value ___plugin_name___.kit.LSP.LSPAny The progress data.

---@class ___plugin_name___.kit.LSP.TextDocumentPositionParams
---@field public textDocument ___plugin_name___.kit.LSP.TextDocumentIdentifier The text document.
---@field public position ___plugin_name___.kit.LSP.Position The position inside the text document.

---@class ___plugin_name___.kit.LSP.WorkDoneProgressParams
---@field public workDoneToken? ___plugin_name___.kit.LSP.ProgressToken An optional token that a server can use to report work done progress.

---@class ___plugin_name___.kit.LSP.LocationLink
---@field public originSelectionRange? ___plugin_name___.kit.LSP.Range Span of the origin of this link.<br><br>Used as the underlined span for mouse interaction. Defaults to the word range at<br>the definition position.
---@field public targetUri string The target resource identifier of this link.
---@field public targetRange ___plugin_name___.kit.LSP.Range The full target range of this link. If the target for example is a symbol then target range is the<br>range enclosing this symbol not including leading/trailing whitespace but everything else<br>like comments. This information is typically used to highlight the range in the editor.
---@field public targetSelectionRange ___plugin_name___.kit.LSP.Range The range that should be selected and revealed when this link is being followed, e.g the name of a function.<br>Must be contained by the `targetRange`. See also `DocumentSymbol#range`

---@class ___plugin_name___.kit.LSP.Range
---@field public start ___plugin_name___.kit.LSP.Position The range's start position.
---@field public end ___plugin_name___.kit.LSP.Position The range's end position.
...
---@field public added ___plugin_name___.kit.LSP.WorkspaceFolder[] The array of added workspace folders
---@field public removed ___plugin_name___.kit.LSP.WorkspaceFolder[] The array of the removed workspace folders
...
---@field public legend ___plugin_name___.kit.LSP.SemanticTokensLegend The legend used by the server
...
---@field public textDocument ___plugin_name___.kit.LSP.OptionalVersionedTextDocumentIdentifier The text document to change.
---@field public edits (___plugin_name___.kit.LSP.TextEdit | ___plugin_name___.kit.LSP.AnnotatedTextEdit)[] The edits to be applied.<br><br>@since 3.16.0 - support for AnnotatedTextEdit. This is guarded using a<br>client capability.
...
---@field public options? ___plugin_name___.kit.LSP.CreateFileOptions Additional options
...
---@field public options? ___plugin_name___.kit.LSP.RenameFileOptions Rename options.
...
---@field public options? ___plugin_name___.kit.LSP.DeleteFileOptions Delete options.
...
---@field public pattern ___plugin_name___.kit.LSP.FileOperationPattern The actual file operation pattern.
...
---@field public stoppedLocation ___plugin_name___.kit.LSP.Range The document range where execution has stopped.<br>Typically the end position of the range denotes the line where the inline values are shown.

---@class ___plugin_name___.kit.LSP.InlineValueText
---@field public range ___plugin_name___.kit.LSP.Range The document range for which the inline value applies.
---@field public text string The text of the inline value.

---@class ___plugin_name___.kit.LSP.InlineValueVariableLookup
---@field public range ___plugin_name___.kit.LSP.Range The document range for which the inline value applies.<br>The range is used to extract the variable name from the underlying document.
...
---@field public range ___plugin_name___.kit.LSP.Range The document range for which the inline value applies.<br>The range is used to extract the evaluatable expression from the underlying document.
...
---@field public tooltip? (string | ___plugin_name___.kit.LSP.MarkupContent) The tooltip text when you hover over this label part. Depending on<br>the client capability `inlayHint.resolveSupport` clients might resolve<br>this property late using the resolve request.
---@field public location? ___plugin_name___.kit.LSP.Location An optional source code location that represents this<br>label part.<br><br>The editor will use this location for the hover and for code navigation<br>features: This part will become a clickable link that resolves to the<br>definition of the symbol at the given location (not necessarily the<br>location itself), it shows the hover that shows at the given location,<br>and it shows a context menu with further code navigation commands.<br><br>Depending on the client capability `inlayHint.resolveSupport` clients<br>might resolve this property late using the resolve request.
---@field public command? ___plugin_name___.kit.LSP.Command An optional command for this label part.<br><br>Depending on the client capability `inlayHint.resolveSupport` clients<br>might resolve this property late using the resolve request.

---@class ___plugin_name___.kit.LSP.MarkupContent
---@field public kind ___plugin_name___.kit.LSP.MarkupKind The type of the Markup
...
---@field public items ___plugin_name___.kit.LSP.Diagnostic[] The actual items.
...
---@field public metadata? ___plugin_name___.kit.LSP.LSPObject Additional metadata stored with the notebook<br>document.<br><br>Note: should always be an object literal (e.g. LSPObject)
---@field public cells ___plugin_name___.kit.LSP.NotebookCell[] The cells of a notebook.
...
---@field public metadata? ___plugin_name___.kit.LSP.LSPObject The changed meta data if any.<br><br>Note: should always be an object literal (e.g. LSPObject)
---@field public cells? ___plugin_name___.kit.LSP.NotebookDocumentChangeEvent.cells Changes to cells

---@class ___plugin_name___.kit.LSP.NotebookDocumentChangeEvent.cells
---@field public structure? ___plugin_name___.kit.LSP.NotebookDocumentChangeEvent.cells.structure Changes to the cell structure to add or<br>remove cells.
---@field public data? ___plugin_name___.kit.LSP.NotebookCell[] Changes to notebook cells properties like its<br>kind, execution summary or metadata.
---@field public textContent? { document: ___plugin_name___.kit.LSP.VersionedTextDocumentIdentifier, changes: ___plugin_name___.kit.LSP.TextDocumentContentChangeEvent[] }[] Changes to the text content of notebook cells.

---@class ___plugin_name___.kit.LSP.NotebookDocumentChangeEvent.cells.structure
---@field public array ___plugin_name___.kit.LSP.NotebookCellArrayChange The change to the cell array.
---@field public didOpen? ___plugin_name___.kit.LSP.TextDocumentItem[] Additional opened cell text documents.
---@field public didClose? ___plugin_name___.kit.LSP.TextDocumentIdentifier[] Additional closed cell text documents.
...
---@field public registerOptions? ___plugin_name___.kit.LSP.LSPAny Options necessary for the registration.
...
---@field public clientInfo? ___plugin_name___.kit.LSP._InitializeParams.clientInfo Information about the client<br><br>@since 3.15.0
...
---@field public capabilities ___plugin_name___.kit.LSP.ClientCapabilities The capabilities provided by the client (editor or tool)
---@field public initializationOptions? ___plugin_name___.kit.LSP.LSPAny User provided initialization options.
---@field public trace? ("off" | "messages" | "compact" | "verbose") The initial trace setting. If omitted trace is disabled ('off').

---@class ___plugin_name___.kit.LSP._InitializeParams.clientInfo
...
---@field public positionEncoding? ___plugin_name___.kit.LSP.PositionEncodingKind The position encoding the server picked from the encodings offered<br>by the client via the client capability `general.positionEncodings`.<br><br>If the client didn't provide any position encodings the only valid<br>value that a server can return is 'utf-16'.<br><br>If omitted it defaults to 'utf-16'.<br><br>@since 3.17.0
---@field public textDocumentSync? (___plugin_name___.kit.LSP.TextDocumentSyncOptions | ___plugin_name___.kit.LSP.TextDocumentSyncKind) Defines how text documents are synced. Is either a detailed structure<br>defining each notification or for backwards compatibility the<br>TextDocumentSyncKind number.
---@field public notebookDocumentSync? (___plugin_name___.kit.LSP.NotebookDocumentSyncOptions | ___plugin_name___.kit.LSP.NotebookDocumentSyncRegistrationOptions) Defines how notebook documents are synced.<br><br>@since 3.17.0
---@field public completionProvider? ___plugin_name___.kit.LSP.CompletionOptions The server provides completion support.
---@field public hoverProvider? (boolean | ___plugin_name___.kit.LSP.HoverOptions) The server provides hover support.
---@field public signatureHelpProvider? ___plugin_name___.kit.LSP.SignatureHelpOptions The server provides signature help support.
---@field public declarationProvider? (boolean | ___plugin_name___.kit.LSP.DeclarationOptions | ___plugin_name___.kit.LSP.DeclarationRegistrationOptions) The server provides Goto Declaration support.
---@field public definitionProvider? (boolean | ___plugin_name___.kit.LSP.DefinitionOptions) The server provides goto definition support.
---@field public typeDefinitionProvider? (boolean | ___plugin_name___.kit.LSP.TypeDefinitionOptions | ___plugin_name___.kit.LSP.TypeDefinitionRegistrationOptions) The server provides Goto Type Definition support.
---@field public implementationProvider? (boolean | ___plugin_name___.kit.LSP.ImplementationOptions | ___plugin_name___.kit.LSP.ImplementationRegistrationOptions) The server provides Goto Implementation support.
---@field public referencesProvider? (boolean | ___plugin_name___.kit.LSP.ReferenceOptions) The server provides find references support.
---@field public documentHighlightProvider? (boolean | ___plugin_name___.kit.LSP.DocumentHighlightOptions) The server provides document highlight support.
---@field public documentSymbolProvider? (boolean | ___plugin_name___.kit.LSP.DocumentSymbolOptions) The server provides document symbol support.
---@field public codeActionProvider? (boolean | ___plugin_name___.kit.LSP.CodeActionOptions) The server provides code actions. CodeActionOptions may only be<br>specified if the client states that it supports<br>`codeActionLiteralSupport` in its initial `initialize` request.
---@field public codeLensProvider? ___plugin_name___.kit.LSP.CodeLensOptions The server provides code lens.
---@field public documentLinkProvider? ___plugin_name___.kit.LSP.DocumentLinkOptions The server provides document link support.
---@field public colorProvider? (boolean | ___plugin_name___.kit.LSP.DocumentColorOptions | ___plugin_name___.kit.LSP.DocumentColorRegistrationOptions) The server provides color provider support.
---@field public workspaceSymbolProvider? (boolean | ___plugin_name___.kit.LSP.WorkspaceSymbolOptions) The server provides workspace symbol support.
---@field public documentFormattingProvider? (boolean | ___plugin_name___.kit.LSP.DocumentFormattingOptions) The server provides document formatting.
---@field public documentRangeFormattingProvider? (boolean | ___plugin_name___.kit.LSP.DocumentRangeFormattingOptions) The server provides document range formatting.
---@field public documentOnTypeFormattingProvider? ___plugin_name___.kit.LSP.DocumentOnTypeFormattingOptions The server provides document formatting on typing.
---@field public renameProvider? (boolean | ___plugin_name___.kit.LSP.RenameOptions) The server provides rename support. RenameOptions may only be<br>specified if the client states that it supports<br>`prepareSupport` in its initial `initialize` request.
---@field public foldingRangeProvider? (boolean | ___plugin_name___.kit.LSP.FoldingRangeOptions | ___plugin_name___.kit.LSP.FoldingRangeRegistrationOptions) The server provides folding provider support.
---@field public selectionRangeProvider? (boolean | ___plugin_name___.kit.LSP.SelectionRangeOptions | ___plugin_name___.kit.LSP.SelectionRangeRegistrationOptions) The server provides selection range support.
---@field public executeCommandProvider? ___plugin_name___.kit.LSP.ExecuteCommandOptions The server provides execute command support.
---@field public callHierarchyProvider? (boolean | ___plugin_name___.kit.LSP.CallHierarchyOptions | ___plugin_name___.kit.LSP.CallHierarchyRegistrationOptions) The server provides call hierarchy support.<br><br>@since 3.16.0
---@field public linkedEditingRangeProvider? (boolean | ___plugin_name___.kit.LSP.LinkedEditingRangeOptions | ___plugin_name___.kit.LSP.LinkedEditingRangeRegistrationOptions) The server provides linked editing range support.<br><br>@since 3.16.0
---@field public semanticTokensProvider? (___plugin_name___.kit.LSP.SemanticTokensOptions | ___plugin_name___.kit.LSP.SemanticTokensRegistrationOptions) The server provides semantic tokens support.<br><br>@since 3.16.0
---@field public monikerProvider? (boolean | ___plugin_name___.kit.LSP.MonikerOptions | ___plugin_name___.kit.LSP.MonikerRegistrationOptions) The server provides moniker support.<br><br>@since 3.16.0
---@field public typeHierarchyProvider? (boolean | ___plugin_name___.kit.LSP.TypeHierarchyOptions | ___plugin_name___.kit.LSP.TypeHierarchyRegistrationOptions) The server provides type hierarchy support.<br><br>@since 3.17.0
---@field public inlineValueProvider? (boolean | ___plugin_name___.kit.LSP.InlineValueOptions | ___plugin_name___.kit.LSP.InlineValueRegistrationOptions) The server provides inline values.<br><br>@since 3.17.0
---@field public inlayHintProvider? (boolean | ___plugin_name___.kit.LSP.InlayHintOptions | ___plugin_name___.kit.LSP.InlayHintRegistrationOptions) The server provides inlay hints.<br><br>@since 3.17.0
---@field public diagnosticProvider? (___plugin_name___.kit.LSP.DiagnosticOptions | ___plugin_name___.kit.LSP.DiagnosticRegistrationOptions) The server has support for pull model diagnostics.<br><br>@since 3.17.0
---@field public workspace? ___plugin_name___.kit.LSP.ServerCapabilities.workspace Workspace specific server capabilities.
---@field public experimental? ___plugin_name___.kit.LSP.LSPAny Experimental server capabilities.

---@class ___plugin_name___.kit.LSP.ServerCapabilities.workspace
---@field public workspaceFolders? ___plugin_name___.kit.LSP.WorkspaceFoldersServerCapabilities The server supports workspace folder.<br><br>@since 3.6.0
---@field public fileOperations? ___plugin_name___.kit.LSP.FileOperationOptions The server is interested in notifications/requests for operations on files.<br><br>@since 3.16.0
...
---@field public type ___plugin_name___.kit.LSP.FileChangeType The change type.

---@class ___plugin_name___.kit.LSP.FileSystemWatcher
---@field public globPattern ___plugin_name___.kit.LSP.GlobPattern The glob pattern to watch. See {@link GlobPattern glob pattern} for more detail.<br><br>@since 3.17.0 support for relative patterns.
---@field public kind? ___plugin_name___.kit.LSP.WatchKind The kind of events of interest. If omitted it defaults<br>to WatchKind.Create | WatchKind.Change | WatchKind.Delete<br>which is 7.

---@class ___plugin_name___.kit.LSP.Diagnostic
---@field public range ___plugin_name___.kit.LSP.Range The range at which the message applies
---@field public severity? ___plugin_name___.kit.LSP.DiagnosticSeverity The diagnostic's severity. Can be omitted. If omitted it is up to the<br>client to interpret diagnostics as error, warning, info or hint.
---@field public code? (integer | string) The diagnostic's code, which usually appear in the user interface.
---@field public codeDescription? ___plugin_name___.kit.LSP.CodeDescription An optional property to describe the error code.<br>Requires the code field (above) to be present/not null.<br><br>@since 3.16.0
...
---@field public tags? ___plugin_name___.kit.LSP.DiagnosticTag[] Additional metadata about the diagnostic.<br><br>@since 3.15.0
---@field public relatedInformation? ___plugin_name___.kit.LSP.DiagnosticRelatedInformation[] An array of related diagnostic information, e.g. when symbol-names within<br>a scope collide all definitions can be marked via this property.
---@field public data? ___plugin_name___.kit.LSP.LSPAny A data entry field that is preserved between a `textDocument/publishDiagnostics`<br>notification and `textDocument/codeAction` request.<br><br>@since 3.16.0

---@class ___plugin_name___.kit.LSP.CompletionContext
---@field public triggerKind ___plugin_name___.kit.LSP.CompletionTriggerKind How the completion was triggered.
...
---@field public insert ___plugin_name___.kit.LSP.Range The range if the insert is requested
---@field public replace ___plugin_name___.kit.LSP.Range The range if the replace is requested.
...
---@field public completionItem? ___plugin_name___.kit.LSP.CompletionOptions.completionItem The server supports the following `CompletionItem` specific<br>capabilities.<br><br>@since 3.17.0

---@class ___plugin_name___.kit.LSP.CompletionOptions.completionItem
...
---@field public triggerKind ___plugin_name___.kit.LSP.SignatureHelpTriggerKind Action that caused signature help to be triggered.
...
---@field public activeSignatureHelp? ___plugin_name___.kit.LSP.SignatureHelp The currently active `SignatureHelp`.<br><br>The `activeSignatureHelp` has its `SignatureHelp.activeSignature` field updated based on<br>the user navigating through available signatures.
...
---@field public documentation? (string | ___plugin_name___.kit.LSP.MarkupContent) The human-readable doc-comment of this signature. Will be shown<br>in the UI but can be omitted.
---@field public parameters? ___plugin_name___.kit.LSP.ParameterInformation[] The parameters of this signature.
...
---@field public kind ___plugin_name___.kit.LSP.SymbolKind The kind of this symbol.
---@field public tags? ___plugin_name___.kit.LSP.SymbolTag[] Tags for this symbol.<br><br>@since 3.16.0
...
---@field public diagnostics ___plugin_name___.kit.LSP.Diagnostic[] An array of diagnostics known on the client side overlapping the range provided to the<br>`textDocument/codeAction` request. They are provided so that the server knows which<br>errors are currently presented to the user for the given range. There is no guarantee<br>that these accurately reflect the error state of the resource. The primary parameter<br>to compute code actions is the provided range.
---@field public only? ___plugin_name___.kit.LSP.CodeActionKind[] Requested kind of actions to return.<br><br>Actions not of this kind are filtered out by the client before being shown. So servers<br>can omit computing them.
---@field public triggerKind? ___plugin_name___.kit.LSP.CodeActionTriggerKind The reason why code actions were requested.<br><br>@since 3.17.0

---@class ___plugin_name___.kit.LSP.CodeActionOptions
---@field public codeActionKinds? ___plugin_name___.kit.LSP.CodeActionKind[] CodeActionKinds that this server may return.<br><br>The list of kinds may be generic, such as `CodeActionKind.Refactor`, or the server<br>may list out every specific kind they provide.
...
---@field public annotationId ___plugin_name___.kit.LSP.ChangeAnnotationIdentifier The actual identifier of the change annotation

---@class ___plugin_name___.kit.LSP.ResourceOperation
---@field public kind string The resource operation kind.
---@field public annotationId? ___plugin_name___.kit.LSP.ChangeAnnotationIdentifier An optional annotation identifier describing the operation.<br><br>@since 3.16.0
...
---@field public matches? ___plugin_name___.kit.LSP.FileOperationPatternKind Whether to match files or folders with this pattern.<br><br>Matches both if undefined.
---@field public options? ___plugin_name___.kit.LSP.FileOperationPatternOptions Additional options used during matching.
...
---@field public kind ___plugin_name___.kit.LSP.NotebookCellKind The cell's kind
---@field public document string The URI of the cell's text document<br>content.
---@field public metadata? ___plugin_name___.kit.LSP.LSPObject Additional metadata stored with the cell.<br><br>Note: should always be an object literal (e.g. LSPObject)
---@field public executionSummary? ___plugin_name___.kit.LSP.ExecutionSummary Additional execution summary information<br>if supported by the client.
...
---@field public cells? ___plugin_name___.kit.LSP.NotebookCell[] The new cells, if any

---@class ___plugin_name___.kit.LSP.ClientCapabilities
---@field public workspace? ___plugin_name___.kit.LSP.WorkspaceClientCapabilities Workspace specific client capabilities.
---@field public textDocument? ___plugin_name___.kit.LSP.TextDocumentClientCapabilities Text document specific client capabilities.
---@field public notebookDocument? ___plugin_name___.kit.LSP.NotebookDocumentClientCapabilities Capabilities specific to the notebook document support.<br><br>@since 3.17.0
---@field public window? ___plugin_name___.kit.LSP.WindowClientCapabilities Window specific client capabilities.
---@field public general? ___plugin_name___.kit.LSP.GeneralClientCapabilities General client capabilities.<br><br>@since 3.16.0
---@field public experimental? ___plugin_name___.kit.LSP.LSPAny Experimental client capabilities.
...
---@field public change? ___plugin_name___.kit.LSP.TextDocumentSyncKind Change notifications are sent to the server. See TextDocumentSyncKind.None, TextDocumentSyncKind.Full<br>and TextDocumentSyncKind.Incremental. If omitted it defaults to TextDocumentSyncKind.None.
...
---@field public save? (boolean | ___plugin_name___.kit.LSP.SaveOptions) If present save notifications are sent to the server. If omitted the notification should not be<br>sent.

---@class ___plugin_name___.kit.LSP.NotebookDocumentSyncOptions
---@field public notebookSelector ({ notebook: (string | ___plugin_name___.kit.LSP.NotebookDocumentFilter), cells?: { language: string }[] } | { notebook?: (string | ___plugin_name___.kit.LSP.NotebookDocumentFilter), cells: { language: string }[] })[] The notebooks to be synced
...
---@field public didCreate? ___plugin_name___.kit.LSP.FileOperationRegistrationOptions The server is interested in receiving didCreateFiles notifications.
---@field public willCreate? ___plugin_name___.kit.LSP.FileOperationRegistrationOptions The server is interested in receiving willCreateFiles requests.
---@field public didRename? ___plugin_name___.kit.LSP.FileOperationRegistrationOptions The server is interested in receiving didRenameFiles notifications.
---@field public willRename? ___plugin_name___.kit.LSP.FileOperationRegistrationOptions The server is interested in receiving willRenameFiles requests.
---@field public didDelete? ___plugin_name___.kit.LSP.FileOperationRegistrationOptions The server is interested in receiving didDeleteFiles file notifications.
---@field public willDelete? ___plugin_name___.kit.LSP.FileOperationRegistrationOptions The server is interested in receiving willDeleteFiles file requests.
...
---@field public location ___plugin_name___.kit.LSP.Location The location of this related diagnostic information.
...
---@field public documentation? (string | ___plugin_name___.kit.LSP.MarkupContent) The human-readable doc-comment of this parameter. Will be shown<br>in the UI but can be omitted.

---@class ___plugin_name___.kit.LSP.NotebookCellTextDocumentFilter
---@field public notebook (string | ___plugin_name___.kit.LSP.NotebookDocumentFilter) A filter that matches against the notebook<br>containing the notebook cell. If a string<br>value is provided it matches against the<br>notebook type. '*' matches every notebook.
...
---@field public workspaceEdit? ___plugin_name___.kit.LSP.WorkspaceEditClientCapabilities Capabilities specific to `WorkspaceEdit`s.
---@field public didChangeConfiguration? ___plugin_name___.kit.LSP.DidChangeConfigurationClientCapabilities Capabilities specific to the `workspace/didChangeConfiguration` notification.
---@field public didChangeWatchedFiles? ___plugin_name___.kit.LSP.DidChangeWatchedFilesClientCapabilities Capabilities specific to the `workspace/didChangeWatchedFiles` notification.
---@field public symbol? ___plugin_name___.kit.LSP.WorkspaceSymbolClientCapabilities Capabilities specific to the `workspace/symbol` request.
---@field public executeCommand? ___plugin_name___.kit.LSP.ExecuteCommandClientCapabilities Capabilities specific to the `workspace/executeCommand` request.
...
---@field public semanticTokens? ___plugin_name___.kit.LSP.SemanticTokensWorkspaceClientCapabilities Capabilities specific to the semantic token requests scoped to the<br>workspace.<br><br>@since 3.16.0.
---@field public codeLens? ___plugin_name___.kit.LSP.CodeLensWorkspaceClientCapabilities Capabilities specific to the code lens requests scoped to the<br>workspace.<br><br>@since 3.16.0.
---@field public fileOperations? ___plugin_name___.kit.LSP.FileOperationClientCapabilities The client has support for file notifications/requests for user operations on files.<br><br>Since 3.16.0
---@field public inlineValue? ___plugin_name___.kit.LSP.InlineValueWorkspaceClientCapabilities Capabilities specific to the inline values requests scoped to the<br>workspace.<br><br>@since 3.17.0.
---@field public inlayHint? ___plugin_name___.kit.LSP.InlayHintWorkspaceClientCapabilities Capabilities specific to the inlay hint requests scoped to the<br>workspace.<br><br>@since 3.17.0.
---@field public diagnostics? ___plugin_name___.kit.LSP.DiagnosticWorkspaceClientCapabilities Capabilities specific to the diagnostic requests scoped to the<br>workspace.<br><br>@since 3.17.0.

---@class ___plugin_name___.kit.LSP.TextDocumentClientCapabilities
---@field public synchronization? ___plugin_name___.kit.LSP.TextDocumentSyncClientCapabilities Defines which synchronization capabilities the client supports.
---@field public completion? ___plugin_name___.kit.LSP.CompletionClientCapabilities Capabilities specific to the `textDocument/completion` request.
---@field public hover? ___plugin_name___.kit.LSP.HoverClientCapabilities Capabilities specific to the `textDocument/hover` request.
---@field public signatureHelp? ___plugin_name___.kit.LSP.SignatureHelpClientCapabilities Capabilities specific to the `textDocument/signatureHelp` request.
---@field public declaration? ___plugin_name___.kit.LSP.DeclarationClientCapabilities Capabilities specific to the `textDocument/declaration` request.<br><br>@since 3.14.0
---@field public definition? ___plugin_name___.kit.LSP.DefinitionClientCapabilities Capabilities specific to the `textDocument/definition` request.
---@field public typeDefinition? ___plugin_name___.kit.LSP.TypeDefinitionClientCapabilities Capabilities specific to the `textDocument/typeDefinition` request.<br><br>@since 3.6.0
---@field public implementation? ___plugin_name___.kit.LSP.ImplementationClientCapabilities Capabilities specific to the `textDocument/implementation` request.<br><br>@since 3.6.0
---@field public references? ___plugin_name___.kit.LSP.ReferenceClientCapabilities Capabilities specific to the `textDocument/references` request.
---@field public documentHighlight? ___plugin_name___.kit.LSP.DocumentHighlightClientCapabilities Capabilities specific to the `textDocument/documentHighlight` request.
---@field public documentSymbol? ___plugin_name___.kit.LSP.DocumentSymbolClientCapabilities Capabilities specific to the `textDocument/documentSymbol` request.
---@field public codeAction? ___plugin_name___.kit.LSP.CodeActionClientCapabilities Capabilities specific to the `textDocument/codeAction` request.
---@field public codeLens? ___plugin_name___.kit.LSP.CodeLensClientCapabilities Capabilities specific to the `textDocument/codeLens` request.
---@field public documentLink? ___plugin_name___.kit.LSP.DocumentLinkClientCapabilities Capabilities specific to the `textDocument/documentLink` request.
---@field public colorProvider? ___plugin_name___.kit.LSP.DocumentColorClientCapabilities Capabilities specific to the `textDocument/documentColor` and the<br>`textDocument/colorPresentation` request.<br><br>@since 3.6.0
---@field public formatting? ___plugin_name___.kit.LSP.DocumentFormattingClientCapabilities Capabilities specific to the `textDocument/formatting` request.
---@field public rangeFormatting? ___plugin_name___.kit.LSP.DocumentRangeFormattingClientCapabilities Capabilities specific to the `textDocument/rangeFormatting` request.
---@field public onTypeFormatting? ___plugin_name___.kit.LSP.DocumentOnTypeFormattingClientCapabilities Capabilities specific to the `textDocument/onTypeFormatting` request.
---@field public rename? ___plugin_name___.kit.LSP.RenameClientCapabilities Capabilities specific to the `textDocument/rename` request.
---@field public foldingRange? ___plugin_name___.kit.LSP.FoldingRangeClientCapabilities Capabilities specific to the `textDocument/foldingRange` request.<br><br>@since 3.10.0
---@field public selectionRange? ___plugin_name___.kit.LSP.SelectionRangeClientCapabilities Capabilities specific to the `textDocument/selectionRange` request.<br><br>@since 3.15.0
---@field public publishDiagnostics? ___plugin_name___.kit.LSP.PublishDiagnosticsClientCapabilities Capabilities specific to the `textDocument/publishDiagnostics` notification.
---@field public callHierarchy? ___plugin_name___.kit.LSP.CallHierarchyClientCapabilities Capabilities specific to the various call hierarchy requests.<br><br>@since 3.16.0
---@field public semanticTokens? ___plugin_name___.kit.LSP.SemanticTokensClientCapabilities Capabilities specific to the various semantic token request.<br><br>@since 3.16.0
---@field public linkedEditingRange? ___plugin_name___.kit.LSP.LinkedEditingRangeClientCapabilities Capabilities specific to the `textDocument/linkedEditingRange` request.<br><br>@since 3.16.0
---@field public moniker? ___plugin_name___.kit.LSP.MonikerClientCapabilities Client capabilities specific to the `textDocument/moniker` request.<br><br>@since 3.16.0
---@field public typeHierarchy? ___plugin_name___.kit.LSP.TypeHierarchyClientCapabilities Capabilities specific to the various type hierarchy requests.<br><br>@since 3.17.0
---@field public inlineValue? ___plugin_name___.kit.LSP.InlineValueClientCapabilities Capabilities specific to the `textDocument/inlineValue` request.<br><br>@since 3.17.0
---@field public inlayHint? ___plugin_name___.kit.LSP.InlayHintClientCapabilities Capabilities specific to the `textDocument/inlayHint` request.<br><br>@since 3.17.0
---@field public diagnostic? ___plugin_name___.kit.LSP.DiagnosticClientCapabilities Capabilities specific to the diagnostic pull model.<br><br>@since 3.17.0

---@class ___plugin_name___.kit.LSP.NotebookDocumentClientCapabilities
---@field public synchronization ___plugin_name___.kit.LSP.NotebookDocumentSyncClientCapabilities Capabilities specific to notebook document synchronization<br><br>@since 3.17.0
...
---@field public baseUri (___plugin_name___.kit.LSP.WorkspaceFolder | string) A workspace folder or a base URI to which this pattern will be matched<br>against relatively.
---@field public pattern ___plugin_name___.kit.LSP.Pattern The actual glob pattern;
...
---@field public resourceOperations? ___plugin_name___.kit.LSP.ResourceOperationKind[] The resource operations the client supports. Clients should at least<br>support 'create', 'rename' and 'delete' files and folders.<br><br>@since 3.13.0
---@field public failureHandling? ___plugin_name___.kit.LSP.FailureHandlingKind The failure handling strategy of a client if applying the workspace edit<br>fails.<br><br>@since 3.13.0
...
---@field public changeAnnotationSupport? ___plugin_name___.kit.LSP.WorkspaceEditClientCapabilities.changeAnnotationSupport Whether the client in general supports change annotations on text edits,<br>create file, rename file and delete file changes.<br><br>@since 3.16.0

---@class ___plugin_name___.kit.LSP.WorkspaceEditClientCapabilities.changeAnnotationSupport
...
---@field public symbolKind? ___plugin_name___.kit.LSP.WorkspaceSymbolClientCapabilities.symbolKind Specific capabilities for the `SymbolKind` in the `workspace/symbol` request.
---@field public tagSupport? ___plugin_name___.kit.LSP.WorkspaceSymbolClientCapabilities.tagSupport The client supports tags on `SymbolInformation`.<br>Clients supporting tags have to handle unknown tags gracefully.<br><br>@since 3.16.0
---@field public resolveSupport? ___plugin_name___.kit.LSP.WorkspaceSymbolClientCapabilities.resolveSupport The client support partial workspace symbols. The client will send the<br>request `workspaceSymbol/resolve` to the server to resolve additional<br>properties.<br><br>@since 3.17.0

---@class ___plugin_name___.kit.LSP.WorkspaceSymbolClientCapabilities.symbolKind
---@field public valueSet? ___plugin_name___.kit.LSP.SymbolKind[] The symbol kind values the client supports. When this<br>property exists the client also guarantees that it will<br>handle values outside its set gracefully and falls back<br>to a default value when unknown.<br><br>If this property is not present the client only supports<br>the symbol kinds from `File` to `Array` as defined in<br>the initial version of the protocol.

---@class ___plugin_name___.kit.LSP.WorkspaceSymbolClientCapabilities.tagSupport
---@field public valueSet ___plugin_name___.kit.LSP.SymbolTag[] The tags supported by the client.

---@class ___plugin_name___.kit.LSP.WorkspaceSymbolClientCapabilities.resolveSupport
...
---@field public completionItem? ___plugin_name___.kit.LSP.CompletionClientCapabilities.completionItem The client supports the following `CompletionItem` specific<br>capabilities.
---@field public completionItemKind? ___plugin_name___.kit.LSP.CompletionClientCapabilities.completionItemKind
---@field public insertTextMode? ___plugin_name___.kit.LSP.InsertTextMode Defines how the client handles whitespace and indentation<br>when accepting a completion item that uses multi line<br>text in either `insertText` or `textEdit`.<br><br>@since 3.17.0
...
---@field public completionList? ___plugin_name___.kit.LSP.CompletionClientCapabilities.completionList The client supports the following `CompletionList` specific<br>capabilities.<br><br>@since 3.17.0

---@class ___plugin_name___.kit.LSP.CompletionClientCapabilities.completionItem
...
---@field public documentationFormat? ___plugin_name___.kit.LSP.MarkupKind[] Client supports the following content formats for the documentation<br>property. The order describes the preferred format of the client.
...
---@class ___plugin_name___.kit.LSP.CompletionClientCapabilities.completionItem.tagSupport
---@field public valueSet ___plugin_name___.kit.LSP.CompletionItemTag[] The tags supported by the client.

---@class ___plugin_name___.kit.LSP.CompletionClientCapabilities.completionItem.resolveSupport
---@field public properties string[] The properties that a client can resolve lazily.

---@class ___plugin_name___.kit.LSP.CompletionClientCapabilities.completionItem.insertTextModeSupport
---@field public valueSet ___plugin_name___.kit.LSP.InsertTextMode[]

---@class ___plugin_name___.kit.LSP.CompletionClientCapabilities.completionItemKind
---@field public valueSet? ___plugin_name___.kit.LSP.CompletionItemKind[] The completion item kind values the client supports. When this<br>property exists the client also guarantees that it will<br>handle values outside its set gracefully and falls back<br>to a default value when unknown.<br><br>If this property is not present the client only supports<br>the completion items kinds from `Text` to `Reference` as defined in<br>the initial version of the protocol.

---@class ___plugin_name___.kit.LSP.CompletionClientCapabilities.completionList
...
---@field public contentFormat? ___plugin_name___.kit.LSP.MarkupKind[] Client supports the following content formats for the content<br>property. The order describes the preferred format of the client.
...
---@field public signatureInformation? ___plugin_name___.kit.LSP.SignatureHelpClientCapabilities.signatureInformation The client supports the following `SignatureInformation`<br>specific properties.
...
---@class ___plugin_name___.kit.LSP.SignatureHelpClientCapabilities.signatureInformation
---@field public documentationFormat? ___plugin_name___.kit.LSP.MarkupKind[] Client supports the following content formats for the documentation<br>property. The order describes the preferred format of the client.
---@field public parameterInformation? ___plugin_name___.kit.LSP.SignatureHelpClientCapabilities.signatureInformation.parameterInformation Client capabilities specific to parameter information.
...
---@class ___plugin_name___.kit.LSP.SignatureHelpClientCapabilities.signatureInformation.parameterInformation
...
---@class ___plugin_name___.kit.LSP.DocumentSymbolClientCapabilities.symbolKind
---@field public valueSet? ___plugin_name___.kit.LSP.SymbolKind[] The symbol kind values the client supports. When this<br>property exists the client also guarantees that it will<br>handle values outside its set gracefully and falls back<br>to a default value when unknown.<br><br>If this property is not present the client only supports<br>the symbol kinds from `File` to `Array` as defined in<br>the initial version of the protocol.

---@class ___plugin_name___.kit.LSP.DocumentSymbolClientCapabilities.tagSupport
---@field public valueSet ___plugin_name___.kit.LSP.SymbolTag[] The tags supported by the client.
...
---@field public resolveSupport? ___plugin_name___.kit.LSP.CodeActionClientCapabilities.resolveSupport Whether the client supports resolving additional code action<br>properties via a separate `codeAction/resolve` request.<br><br>@since 3.16.0
...
---@class ___plugin_name___.kit.LSP.CodeActionClientCapabilities.codeActionLiteralSupport
---@field public codeActionKind ___plugin_name___.kit.LSP.CodeActionClientCapabilities.codeActionLiteralSupport.codeActionKind The code action kind is support with the following value<br>set.

---@class ___plugin_name___.kit.LSP.CodeActionClientCapabilities.codeActionLiteralSupport.codeActionKind
---@field public valueSet ___plugin_name___.kit.LSP.CodeActionKind[] The code action kind values the client supports. When this<br>property exists the client also guarantees that it will<br>handle values outside its set gracefully and falls back<br>to a default value when unknown.

---@class ___plugin_name___.kit.LSP.CodeActionClientCapabilities.resolveSupport
---@field public properties string[] The properties that a client can resolve lazily.
...
---@field public prepareSupportDefaultBehavior? ___plugin_name___.kit.LSP.PrepareSupportDefaultBehavior Client supports the default behavior result.<br><br>The value indicates the default behavior used by the<br>client.<br><br>@since 3.16.0
...
---@field public foldingRangeKind? ___plugin_name___.kit.LSP.FoldingRangeClientCapabilities.foldingRangeKind Specific options for the folding range kind.<br><br>@since 3.17.0
---@field public foldingRange? ___plugin_name___.kit.LSP.FoldingRangeClientCapabilities.foldingRange Specific options for the folding range.<br><br>@since 3.17.0

---@class ___plugin_name___.kit.LSP.FoldingRangeClientCapabilities.foldingRangeKind
---@field public valueSet? ___plugin_name___.kit.LSP.FoldingRangeKind[] The folding range kind values the client supports. When this<br>property exists the client also guarantees that it will<br>handle values outside its set gracefully and falls back<br>to a default value when unknown.

---@class ___plugin_name___.kit.LSP.FoldingRangeClientCapabilities.foldingRange
...
---@field public tagSupport? ___plugin_name___.kit.LSP.PublishDiagnosticsClientCapabilities.tagSupport Client supports the tag property to provide meta data about a diagnostic.<br>Clients supporting tags have to handle unknown tags gracefully.<br><br>@since 3.15.0
...
---@class ___plugin_name___.kit.LSP.PublishDiagnosticsClientCapabilities.tagSupport
---@field public valueSet ___plugin_name___.kit.LSP.DiagnosticTag[] The tags supported by the client.
...
---@field public formats ___plugin_name___.kit.LSP.TokenFormat[] The token formats the clients supports.
...
---@class ___plugin_name___.kit.LSP.SemanticTokensClientCapabilities.requests
...
---@field public resolveSupport? ___plugin_name___.kit.LSP.InlayHintClientCapabilities.resolveSupport Indicates which properties a client can resolve lazily on an inlay<br>hint.

---@class ___plugin_name___.kit.LSP.InlayHintClientCapabilities.resolveSupport
---@field public properties string[] The properties that a client can resolve lazily.
...
---@field public messageActionItem? ___plugin_name___.kit.LSP.ShowMessageRequestClientCapabilities.messageActionItem Capabilities specific to the `MessageActionItem` type.

---@class ___plugin_name___.kit.LSP.ShowMessageRequestClientCapabilities.messageActionItem
