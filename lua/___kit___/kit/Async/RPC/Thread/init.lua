...
local Session = require('___kit___.kit.Async.RPC.Session')

---@class ___kit___.kit.Async.RPC.Thread
---@field private thread uv.luv_thread_t
---@field private session ___kit___.kit.Async.RPC.Session
local Thread = {}
Thread.__index = Thread

---Create new thread.
---@param dispatcher_ fun(session: ___kit___.kit.Async.RPC.Session)
