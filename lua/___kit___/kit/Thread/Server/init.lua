...
---@class ___kit___.kit.Thread.Server
---@field private dispatcher fun(session: ___kit___.kit.Thread.Server.Session): nil
---@field private session? ___kit___.kit.Thread.Server.Session
...
---@param dispatcher fun(session: ___kit___.kit.Thread.Server.Session): nil
---@return ___kit___.kit.Thread.Server
...
function Server:connect()
  return Async.run(function()
    ...
    vim.api.nvim_create_autocmd({ 'VimLeave' }, {
      desc = '___kit___.kit.Thread.Server:on_exit',
      once = true,
      callback = function()
        self:kill()
      end
