...
---@alias ___kit___.kit.Vim.FloatingWindow.WindowKind 'main' | 'scrollbar_track' | 'scrollbar_thumb'

---@class ___kit___.kit.Vim.FloatingWindow.BorderSize
...
---@class ___kit___.kit.Vim.FloatingWindow.ContentSize
---@field public width integer
---@field public height integer

---@class ___kit___.kit.Vim.FloatingWindow.WindowConfig
...
---@field public border_size ___kit___.kit.Vim.FloatingWindow.BorderSize
---@field public content_size ___kit___.kit.Vim.FloatingWindow.ContentSize
...
---@class ___kit___.kit.Vim.FloatingWindow.Config
---@field public markdown? boolean

---@class ___kit___.kit.Vim.FloatingWindow
---@field private _augroup string
---@field private _config ___kit___.kit.Vim.FloatingWindow.Config
...
---@return ___kit___.kit.Vim.FloatingWindow.ContentSize
...
---@param params { border_size: ___kit___.kit.Vim.FloatingWindow.BorderSize, content_size: ___kit___.kit.Vim.FloatingWindow.ContentSize, max_outer_width: integer, max_outer_height: integer }
...
---Create window.
---@return ___kit___.kit.Vim.FloatingWindow
function FloatingWindow.new()
  return setmetatable({
    _augroup = vim.api.nvim_create_augroup(('___kit___.kit.Vim.FloatingWindow:%s'):format(kit.unique_id()), {
      clear = true,
    }),
    _config = {
      markdown = false,
...
---Get config.
---@return ___kit___.kit.Vim.FloatingWindow.Config
...
---@param key string
---@param value any
---@param kind? ___kit___.kit.Vim.FloatingWindow.WindowKind
