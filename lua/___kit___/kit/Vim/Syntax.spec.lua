...
local Syntax = require('___kit___.kit.Vim.Syntax')
...
describe('kit.Vim.Syntax', function()
  ...
  it('should return vim syntax group', function()
    ...
    assert.are.same(Syntax.get_syntax_groups({ 0, 4 }), { 'Normal', 'vimVar' })
    assert.are.same(Syntax.get_syntax_groups({ 0, 6 }), { 'Normal', 'vimVar' })
