...
---@class ___kit___.kit.RPC.JSON.Transport
---@field send fun(self: ___kit___.kit.RPC.JSON.Transport, data: table): ___kit___.kit.Async.AsyncTask
---@field on_message fun(self: ___kit___.kit.RPC.JSON.Transport, callback: fun(data: table))
---@field start fun(self: ___kit___.kit.RPC.JSON.Transport)
---@field close fun(self: ___kit___.kit.RPC.JSON.Transport): ___kit___.kit.Async.AsyncTask

---@class ___kit___.kit.RPC.JSON.Transport.LineDelimitedPipe: ___kit___.kit.RPC.JSON.Transport
---@field private _buffer ___kit___.kit.buffer.Buffer
...
---@class ___kit___.kit.RPC.JSON.RPC
---@field private _transport ___kit___.kit.RPC.JSON.Transport
...
---@param params { transport: ___kit___.kit.RPC.JSON.Transport }
