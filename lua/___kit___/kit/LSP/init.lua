...
---@enum ___kit___.kit.LSP.TraceValues
LSP.TraceValues = {
  Off = 'off',
  Messages = 'messages',
  Verbose = 'verbose',
...
---@field public textEdit? ___kit___.kit.LSP.TextEdit An [edit](#TextEdit) which is applied to a document when selecting<br>this presentation for the color.  When `falsy` the [label](#ColorPresentation.label)<br>is used.
---@field public additionalTextEdits? ___kit___.kit.LSP.TextEdit[] An optional array of additional [text edits](#TextEdit) that are applied when<br>selecting this color presentation. Edits must not overlap with the main [edit](#ColorPresentation.textEdit) nor with themselves.
...
---@field public position ___kit___.kit.LSP.Position The position of this hint.
...
---@field public serverInfo? ___kit___.kit.LSP.InitializeResult.serverInfo Information about the server.<br><br>@since 3.15.0

---@class ___kit___.kit.LSP.InitializeResult.serverInfo
...
---@field public textEdit? (___kit___.kit.LSP.TextEdit | ___kit___.kit.LSP.InsertReplaceEdit) An [edit](#TextEdit) which is applied to a document when selecting<br>this completion. When an edit is provided the value of<br>[insertText](#CompletionItem.insertText) is ignored.<br><br>Most editors support two different operations when accepting a completion<br>item. One is to insert a completion text and the other is to replace an<br>existing text with a completion text. Since this can usually not be<br>predetermined by a server it can report both ranges. Clients need to<br>signal support for `InsertReplaceEdits` via the<br>`textDocument.completion.insertReplaceSupport` client capability<br>property.<br><br>*Note 1:* The text edit's range as well as both ranges from an insert<br>replace edit must be a [single line] and they must contain the position<br>at which completion has been requested.<br>*Note 2:* If an `InsertReplaceEdit` is returned the edit's insert range<br>must be a prefix of the edit's replace range, that means it must be<br>contained and starting at the same position.<br><br>@since 3.16.0 additional type `InsertReplaceEdit`
...
---@field public command? ___kit___.kit.LSP.Command An optional [command](#Command) that is executed *after* inserting this completion. *Note* that<br>additional modifications to the current document should be described with the<br>[additionalTextEdits](#CompletionItem.additionalTextEdits)-property.
---@field public data? ___kit___.kit.LSP.LSPAny A data entry field that is preserved on a completion item between a<br>[CompletionRequest](#CompletionRequest) and a [CompletionResolveRequest](#CompletionResolveRequest).
...
---@field public location (___kit___.kit.LSP.Location | { uri: string }) The location of the symbol. Whether a server is allowed to<br>return a location without a range depends on the client<br>capability `workspace.symbol.resolveSupport`.<br><br>See SymbolInformation#location for more details.
...
---@field public value ___kit___.kit.LSP.TraceValues
...
---@field public edits (___kit___.kit.LSP.TextEdit | ___kit___.kit.LSP.AnnotatedTextEdit)[] The edits to be applied.<br><br>@since 3.16.0 - support for AnnotatedTextEdit. This is guarded using a<br>client capability.
...
---@field public cells? ___kit___.kit.LSP.NotebookDocumentChangeEvent.cells Changes to cells

---@class ___kit___.kit.LSP.NotebookDocumentChangeEvent.cells
---@field public structure? ___kit___.kit.LSP.NotebookDocumentChangeEvent.cells.structure Changes to the cell structure to add or<br>remove cells.
...
---@field public textContent? { document: ___kit___.kit.LSP.VersionedTextDocumentIdentifier, changes: ___kit___.kit.LSP.TextDocumentContentChangeEvent[] }[] Changes to the text content of notebook cells.

---@class ___kit___.kit.LSP.NotebookDocumentChangeEvent.cells.structure
...
---@class ___kit___.kit.LSP._InitializeParams.clientInfo
...
---@field public workspace? ___kit___.kit.LSP.ServerCapabilities.workspace Workspace specific server capabilities.
---@field public experimental? ___kit___.kit.LSP.LSPAny Experimental server capabilities.

---@class ___kit___.kit.LSP.ServerCapabilities.workspace
...
---@field public severity? ___kit___.kit.LSP.DiagnosticSeverity The diagnostic's severity. Can be omitted. If omitted it is up to the<br>client to interpret diagnostics as error, warning, info or hint.
...
---@field public completionItem? ___kit___.kit.LSP.CompletionOptions.completionItem The server supports the following `CompletionItem` specific<br>capabilities.<br><br>@since 3.17.0
...
---@class ___kit___.kit.LSP.LSPObject
...
---@field public staleRequestSupport? ___kit___.kit.LSP.GeneralClientCapabilities.staleRequestSupport Client capability that signals how the client<br>handles stale requests (e.g. a request<br>for which the client will not process the response<br>anymore since the information is outdated).<br><br>@since 3.17.0
...
---@class ___kit___.kit.LSP.GeneralClientCapabilities.staleRequestSupport
...
---@field public changeAnnotationSupport? ___kit___.kit.LSP.WorkspaceEditClientCapabilities.changeAnnotationSupport Whether the client in general supports change annotations on text edits,<br>create file, rename file and delete file changes.<br><br>@since 3.16.0

---@class ___kit___.kit.LSP.WorkspaceEditClientCapabilities.changeAnnotationSupport
...
---@field public symbolKind? ___kit___.kit.LSP.WorkspaceSymbolClientCapabilities.symbolKind Specific capabilities for the `SymbolKind` in the `workspace/symbol` request.
---@field public tagSupport? ___kit___.kit.LSP.WorkspaceSymbolClientCapabilities.tagSupport The client supports tags on `SymbolInformation`.<br>Clients supporting tags have to handle unknown tags gracefully.<br><br>@since 3.16.0
---@field public resolveSupport? ___kit___.kit.LSP.WorkspaceSymbolClientCapabilities.resolveSupport The client support partial workspace symbols. The client will send the<br>request `workspaceSymbol/resolve` to the server to resolve additional<br>properties.<br><br>@since 3.17.0

---@class ___kit___.kit.LSP.WorkspaceSymbolClientCapabilities.symbolKind
...
---@class ___kit___.kit.LSP.WorkspaceSymbolClientCapabilities.tagSupport
---@field public valueSet ___kit___.kit.LSP.SymbolTag[] The tags supported by the client.

---@class ___kit___.kit.LSP.WorkspaceSymbolClientCapabilities.resolveSupport
...
---@field public completionItem? ___kit___.kit.LSP.CompletionClientCapabilities.completionItem The client supports the following `CompletionItem` specific<br>capabilities.
---@field public completionItemKind? ___kit___.kit.LSP.CompletionClientCapabilities.completionItemKind
...
---@field public completionList? ___kit___.kit.LSP.CompletionClientCapabilities.completionList The client supports the following `CompletionList` specific<br>capabilities.<br><br>@since 3.17.0

---@class ___kit___.kit.LSP.CompletionClientCapabilities.completionItem
...
---@field public resolveSupport? ___kit___.kit.LSP.CompletionClientCapabilities.completionItem.resolveSupport Indicates which properties a client can resolve lazily on a completion<br>item. Before version 3.16.0 only the predefined properties `documentation`<br>and `details` could be resolved lazily.<br><br>@since 3.16.0
---@field public insertTextModeSupport? ___kit___.kit.LSP.CompletionClientCapabilities.completionItem.insertTextModeSupport The client supports the `insertTextMode` property on<br>a completion item to override the whitespace handling mode<br>as defined by the client (see `insertTextMode`).<br><br>@since 3.16.0
...
---@class ___kit___.kit.LSP.CompletionClientCapabilities.completionItem.tagSupport
---@field public valueSet ___kit___.kit.LSP.CompletionItemTag[] The tags supported by the client.

---@class ___kit___.kit.LSP.CompletionClientCapabilities.completionItem.resolveSupport
---@field public properties string[] The properties that a client can resolve lazily.

---@class ___kit___.kit.LSP.CompletionClientCapabilities.completionItem.insertTextModeSupport
---@field public valueSet ___kit___.kit.LSP.InsertTextMode[]

---@class ___kit___.kit.LSP.CompletionClientCapabilities.completionItemKind
...
---@class ___kit___.kit.LSP.CompletionClientCapabilities.completionList
...
---@field public signatureInformation? ___kit___.kit.LSP.SignatureHelpClientCapabilities.signatureInformation The client supports the following `SignatureInformation`<br>specific properties.
...
---@class ___kit___.kit.LSP.SignatureHelpClientCapabilities.signatureInformation
---@field public documentationFormat? ___kit___.kit.LSP.MarkupKind[] Client supports the following content formats for the documentation<br>property. The order describes the preferred format of the client.
---@field public parameterInformation? ___kit___.kit.LSP.SignatureHelpClientCapabilities.signatureInformation.parameterInformation Client capabilities specific to parameter information.
...
---@class ___kit___.kit.LSP.SignatureHelpClientCapabilities.signatureInformation.parameterInformation
...
---@class ___kit___.kit.LSP.DocumentSymbolClientCapabilities.symbolKind
---@field public valueSet? ___kit___.kit.LSP.SymbolKind[] The symbol kind values the client supports. When this<br>property exists the client also guarantees that it will<br>handle values outside its set gracefully and falls back<br>to a default value when unknown.<br><br>If this property is not present the client only supports<br>the symbol kinds from `File` to `Array` as defined in<br>the initial version of the protocol.

---@class ___kit___.kit.LSP.DocumentSymbolClientCapabilities.tagSupport
---@field public valueSet ___kit___.kit.LSP.SymbolTag[] The tags supported by the client.
...
---@field public resolveSupport? ___kit___.kit.LSP.CodeActionClientCapabilities.resolveSupport Whether the client supports resolving additional code action<br>properties via a separate `codeAction/resolve` request.<br><br>@since 3.16.0
...
---@class ___kit___.kit.LSP.CodeActionClientCapabilities.codeActionLiteralSupport
---@field public codeActionKind ___kit___.kit.LSP.CodeActionClientCapabilities.codeActionLiteralSupport.codeActionKind The code action kind is support with the following value<br>set.

---@class ___kit___.kit.LSP.CodeActionClientCapabilities.codeActionLiteralSupport.codeActionKind
...
---@class ___kit___.kit.LSP.CodeActionClientCapabilities.resolveSupport
---@field public properties string[] The properties that a client can resolve lazily.
...
---@field public foldingRangeKind? ___kit___.kit.LSP.FoldingRangeClientCapabilities.foldingRangeKind Specific options for the folding range kind.<br><br>@since 3.17.0
---@field public foldingRange? ___kit___.kit.LSP.FoldingRangeClientCapabilities.foldingRange Specific options for the folding range.<br><br>@since 3.17.0

---@class ___kit___.kit.LSP.FoldingRangeClientCapabilities.foldingRangeKind
...
---@class ___kit___.kit.LSP.FoldingRangeClientCapabilities.foldingRange
...
---@class ___kit___.kit.LSP.PublishDiagnosticsClientCapabilities
---@field public relatedInformation? boolean Whether the clients accepts diagnostics with related information.
---@field public tagSupport? ___kit___.kit.LSP.PublishDiagnosticsClientCapabilities.tagSupport Client supports the tag property to provide meta data about a diagnostic.<br>Clients supporting tags have to handle unknown tags gracefully.<br><br>@since 3.15.0
...
---@class ___kit___.kit.LSP.PublishDiagnosticsClientCapabilities.tagSupport
...
---@class ___kit___.kit.LSP.SemanticTokensClientCapabilities.requests
...
---@field public resolveSupport? ___kit___.kit.LSP.InlayHintClientCapabilities.resolveSupport Indicates which properties a client can resolve lazily on an inlay<br>hint.

---@class ___kit___.kit.LSP.InlayHintClientCapabilities.resolveSupport
---@field public properties string[] The properties that a client can resolve lazily.

---@class ___kit___.kit.LSP.DiagnosticClientCapabilities
---@field public dynamicRegistration? boolean Whether implementation supports dynamic registration. If this is set to `true`<br>the client supports the new `(TextDocumentRegistrationOptions & StaticRegistrationOptions)`<br>return value for the corresponding server capability as well.
...
---@field public messageActionItem? ___kit___.kit.LSP.ShowMessageRequestClientCapabilities.messageActionItem Capabilities specific to the `MessageActionItem` type.

---@class ___kit___.kit.LSP.ShowMessageRequestClientCapabilities.messageActionItem
...
---@alias ___kit___.kit.LSP.PrepareRenameResult (___kit___.kit.LSP.Range | { range: ___kit___.kit.LSP.Range, placeholder: string } | { defaultBehavior: boolean })
...
---@alias ___kit___.kit.LSP.TextDocumentContentChangeEvent ({ range: ___kit___.kit.LSP.Range, rangeLength?: integer, text: string } | { text: string })

---@alias ___kit___.kit.LSP.MarkedString (string | { language: string, value: string })
